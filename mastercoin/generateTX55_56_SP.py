...
memo_bytes = ''                                     # var bytes

for let in memo:
    memo_bytes = memo_bytes + hex(ord(let))[2:]
memo_bytes = memo_bytes + '00'
...
byte_stream = tx_ver_bytes + tx_type_bytes + prop_id_bytes + num_prop_bytes + memo_bytes
